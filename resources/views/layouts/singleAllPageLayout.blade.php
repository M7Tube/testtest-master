        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto {{ Request::url() == route('showAllServices', app()->getLocale()) ? 'active' : '' }}"
                            href="{{ route('showAllServices', app()->getLocale()) }}">{{ __('Services') }}</a></li>
                    <li><a class="nav-link scrollto {{ Request::url() == route('showAllItems', app()->getLocale()) ? 'active' : '' }}"
                            href="{{ route('showAllItems', app()->getLocale()) }}">{{ __('Items') }}</a></li>
                    <li><a class="nav-link scrollto {{ Request::url() == route('showAllPosts', app()->getLocale()) ? 'active' : '' }}"
