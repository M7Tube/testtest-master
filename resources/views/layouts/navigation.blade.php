    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('Settings',app()->getLocale())" :active="request()->routeIs('Settings')">
                        {{ __('lang.Settings') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('Statistics',app()->getLocale())" :active="request()->routeIs('Statistics')">
                        {{ __('lang.Statistics') }}
                    </x-nav-link>
                </div>
            </div>
